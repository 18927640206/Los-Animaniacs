...
public class Money {
     ...
     public Money sumar(Money otro) {
         ...
         if (!this.moneda.equals(otro.moneda)) {
             throw new IllegalArgumentException("No se pueden sumar montos con distinta moneda"); // RN-VO-01
         }
     ...
     public Money restar(Money otro) {
         ...
         if (!this.moneda.equals(otro.getMoneda())) {
             throw new IllegalArgumentException("No se pueden restar montos con distinta moneda"); // RN-VO-01
         }
